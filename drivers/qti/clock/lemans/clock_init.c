...
static void clock_disable_boot_imem(void)
{
	...
	mmio_setbits_32(LPASS_LPASS_TOP_CC_LPI_Q6_AXIM_HS_CBCR, HAL_CLK_BRANCH_CTRL_REG_CLK_ENABLE_FMSK);
	for (delay = 500U;
...
int clock_init_image(struct clock_drv_ctxt *drv_ctxt)
{
	...
	mmio_clrsetbits_32(LPASS_AON_CC_LPASS_AUDIO_HM_RETENTION_VOTE,
			   ...
			   0U << LPASS_AON_CC_LPASS_AUDIO_HM_RETENTION_VOTE_SECURE_GDSC_HW_CONTROL_OVERRIDE_SHFT);
	mmio_clrsetbits_32(LPASS_AON_CC_LPASS_PDC_HM_RETENTION_VOTE,
			   ...
			   0U << LPASS_AON_CC_LPASS_PDC_HM_RETENTION_VOTE_SECURE_GDSC_HW_CONTROL_OVERRIDE_SHFT);
	mmio_clrsetbits_32(LPASS_AON_CC_LPASS_AUDIO_ML_RETENTION_VOTE,
			   ...
			   0U << LPASS_AON_CC_LPASS_AUDIO_ML_RETENTION_VOTE_SECURE_GDSC_HW_CONTROL_OVERRIDE_SHFT);
