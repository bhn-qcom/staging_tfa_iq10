 ...
 * These CBOR message tags are assigned as per IANA in the range between 271 and
 * 1000 on a First
...
typedef enum tme_msg_cbor_tag {
	...
	TME_MSG_CBOR_TAG_ERROR                         = TME_MSG_CBOR_TAG_MAX  /* Also used to transmit a CBOR @c int error code */
} tme_msg_cbor_tag_t;
/* clang-format on */
