...
# Use the SPD-agnostic fallback only when no SPD is selected. TF-A defaults
# unspecified SPD to "none"; other SPD configurations must provide their own
# bl31qtilib_spd_* adapter.
ifeq ($(filter-out none,$(strip $(SPD))),)
BL31_SOURCES +=							\
